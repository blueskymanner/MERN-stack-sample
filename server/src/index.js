...
import Writereport from './api/writereport';
...
app.post('/write', Writereport.write)
app.post('/update/:id', Writereport.update)
app.get('/record', Writereport.record)
app.post('/:id', Writereport.delete)
app.post('/record/:id', Writereport.getrecord)
